        ...
        <div class="hidden lg:block lg:ml-10">
          <div class="flex space-x-4">
            ...
            @if(Auth::check() && Auth::user()->role == "MEMBER")
              ...
              <a href="{{ route('carts.index') }}" class="text-white hover:bg-indigo-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium {{ Route::current()->getName() == 'carts.index' ? 'bg-indigo-700' : '' }}">
                My Cart
              </a>
            @endif
          </div>
